...
POSES = [
    ...
    ("c43", "3:4", "A bridesmaid carefully doing up the zipper or buttons on the back of the wedding dress, tender preparation moment."),
    ("c44", "3:4", "A groom tying his necktie or bow tie in front of a mirror, focused expression."),
    ("c45", "1:1", "ONLY a tight close-up crop of hands fastening cufflinks, filling the entire frame. No faces, no full body, no additional figures, no inset circles, no collage, just one single close-up detail image."),
    ("c46", "3:4", "A mother or bridesmaid gently placing the wedding veil onto the bride's head, tender moment."),
    ("c47", "3:4", "A bride looking at herself in a large mirror one last time, calm reflective moment before the ceremony."),
    ("c48", "3:4", "A bride applying perfume to her wrist, soft elegant gesture."),
    ("c49", "3:4", "A bride and groom holding both hands, standing slightly apart from each other, looking at each other lovingly."),
    ("c50", "3:4", "A groom kissing the bride's hand, she smiles touched."),
    ("c51", "3:4", "A bride and groom walking hand in hand across a scenic bridge."),
    ("c52", "3:4", "A bride and groom pushing a flower-decorated bicycle together, laughing."),
    ("c53", "3:4", "A bride and groom walking playfully arm in arm with a little twirl in between."),
    ("c54", "3:4", "A groom kissing the bride's forehead in profile, both eyes closed."),
    ("c55", "3:4", "A bride and groom looking together in the same direction into the distance, hands firmly clasped."),
    ("c56", "3:4", "A groom lifting the bride up and spinning her around in a circle, both laughing."),
    ("c57", "3:4", "A bride and groom in a spontaneous fit of laughter, candid unposed moment."),
    ("c58", "3:4", "The bride playfully holding the bridal bouquet up in front of the groom's face, teasing him."),
    ("c59", "3:4", "A bride and groom's reflection visible in a large window, surrounding architecture included in the frame."),
    ("c60", "3:4", "A bride and groom kissing under an umbrella in light rain."),
    ("c61", "3:4", "A bride and groom standing together framed inside a rustic archway or doorway."),
    ("c62", "3:4", "A bride and groom sitting closely together on a wide window sill."),
    ("c63", "3:4", "A bride and groom sitting with their backs to the camera in front of a lake or body of water."),
    ("c64", "1:1", "ONLY a tight close-up crop of a hand signing a marriage certificate, filling the entire frame. No faces, no full body, no additional figures, no inset circles, no collage, just one single close-up detail image."),
    ("c65", "3:4", "A bride and groom taking their first walk together as a married couple, exiting the church or registry office."),
    ("c66", "3:4", "An emotional close-up moment of the bride and groom reading their wedding vows to each other."),
    ("c67", "3:4", "A bride and groom standing together under string lights or a starry evening sky, romantic mood."),
    ...
    ("f34", "3:4", "A mother helping the bride with the final touches of getting dressed, tender family scene."),
    ("f35", "4:3", "A family toasting together with champagne before the wedding ceremony, relaxed preparation mood."),
    ("f36", "4:3", "A group of bridesmaids laughing together while getting ready."),
    ("f37", "3:4", "A father pinning a boutonniere flower onto the groom's jacket, proud moment."),
    ("f38", "4:3", "A group portrait of only the female family members together with the bride."),
    ("f39", "4:3", "A group portrait of only the male family members together with the groom."),
    ("f40", "4:3", "A group of bridesmaids with the bride standing in the middle."),
    ("f41", "4:3", "A group of groomsmen with the groom standing in the middle."),
    ("f42", "4:3", "A wide group portrait of the whole wedding party standing in front of the venue entrance."),
    ("f43", "4:3", "A group of wedding guests holding sparklers together at dusk."),
    ("f44", "3:4", "An emotional moment of the father walking the bride down the aisle."),
    ("f45", "3:4", "The groom's facial expression at the first sight of the bride, candid emotional reaction."),
    ("f46", "4:3", "Wedding guests standing up and applauding, candid moment."),
    ("f47", "3:4", "A tired small child falling asleep in a parent's arms, quiet tender moment."),
    ("f48", "3:4", "Children playing joyfully in a shower of confetti or flower petals."),
    ("f49", "3:4", "The bride and groom posing together with their pet dog."),
    ("f50", "3:4", "An elderly couple (grandparents) dancing lovingly together."),
    ("f51", "3:4", "Siblings sharing a warm heartfelt hug."),
    ("f52", "4:3", "A group of wedding guests seated together at an elegantly set banquet table."),
    ("f53", "4:3", "A person giving a wedding speech while the group listens attentively and emotionally."),
    ("f54", "4:3", "The bride and groom walking through an aisle of sparklers held by guests."),
    ("f55", "4:3", "A crowded dance floor with many wedding guests dancing joyfully together."),
    ("f56", "4:3", "The bride and groom waving as they get into a decorated car, guests waving back."),
    ("f57", "4:3", "An evening group photo in front of a string-light backdrop."),
    ("f58", "4:3", "The bride and groom sharing one last slow dance together, guests forming a circle around them."),
    ...
    ("k01", "3:4", "A young child in an elegant white communion outfit standing upright, hands folded in front of the body or relaxed at the sides, friendly smile toward the camera."),
    ("k02", "3:4", "A young child proudly holding a decorated communion candle with both hands in front of the body."),
    ("k03", "3:4", "A young teenager in elegant confirmation attire standing at a slight angle, looking back over the shoulder toward the camera."),
    ("k04", "3:4", "A young child with hands folded together in prayer, calm solemn expression."),
    ("k05", "3:4", "A young child proudly holding a small bouquet of flowers or a gift toward the camera."),
    ("k06", "3:4", "A young child sitting relaxed on the steps in front of a church."),
    ("k07", "3:4", "A young teenager sitting sideways on a bench, hands folded in the lap."),
    ("k08", "3:4", "A young child sitting at a festively set table with a candle in front of them."),
    ("k09", "3:4", "A young teenager sitting casually and relaxed on an outdoor staircase."),
    ("k10", "3:4", "A young child sitting while holding a small prayer book or bible in their hands."),
    ("k11", "4:3", "A young child standing between both parents, everyone smiling at the camera."),
    ("k12", "3:4", "A young child together with siblings, standing casually close together."),
    ("k13", "4:3", "A large family group gathered around the child, festive formal arrangement."),
    ("k14", "3:4", "A warm emotional hug between the child and their mother."),
    ("k15", "3:4", "A father carrying the child on his shoulders, both laughing."),
    ("k16", "4:3", "A young child standing between godparents, everyone smiling together."),
    ("k17", "3:4", "A godparent solemnly handing a gift to the child."),
    ("k18", "3:4", "A warm hug between the child and a godparent."),
    ("k19", "4:3", "A group portrait of the child together with several godparents in a row."),
    ("k20", "3:4", "The child holding hands with a godparent, walking together."),
    ("k21", "3:4", "A child solemnly walking into the church, possibly alongside other communion children."),
    ("k22", "3:4", "A child standing solemnly in front of the altar, holding a candle."),
    ("k23", "4:3", "A group portrait of all the communion or confirmation children together in front of the church."),
    ("k24", "3:4", "A solemn moment of a priest or pastor blessing the child."),
    ("k25", "4:3", "A joyful exit from the church after the ceremony, guests in the background."),
    ("k26", "3:4", "A child cutting a festive cake together with their parents."),
    ("k27", "3:4", "A child joyfully unwrapping a gift, genuine surprise on their face."),
    ("k28", "4:3", "A large festive group seated together at a beautifully set table."),
    ("k29", "3:4", "A child happily toasting with a glass of children's punch or juice."),
    ("k30", "3:4", "A child releasing colorful balloons into the sky together with family."),
]
